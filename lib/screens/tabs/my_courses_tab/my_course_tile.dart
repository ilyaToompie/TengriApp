              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Theme.of(context).colorScheme.onSecondary, fontWeight: FontWeight.w700),
                  ),
                  Padding(
                  ...
                  OutlinedButton(
                    style: OutlinedButton.styleFrom(
                        ...
                        textStyle: Theme.of(context).textTheme.titleSmall?.copyWith(fontWeight: FontWeight.w600, color: Theme.of(context).textTheme.bodyLarge?.color)
                        ),
                    child: Text(CourseMixin.enrollButtonText(course, user), style: TextStyle(color: Theme.of(context).textTheme.bodyLarge?.color),).tr(),
